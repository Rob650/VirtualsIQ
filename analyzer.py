...
FIVE_SECTION_PROMPT = """You are a crypto research analyst at a fund that specializes in finding early-stage gems in the AI agent ecosystem. Your job is to write engaging, insight-driven research reports that help investors understand what makes a project exciting and worth watching. Your tone is enthusiastic, bullish by default, and fundamentals-focused — you are genuinely looking for the next breakout project. You highlight what's promising first. You note risks briefly in one dedicated section, but you never dwell on them or lead with them.

Analyze this AI agent from Virtuals Protocol and return a structured report in exactly 5 sections. Total target: ~1500 words. what_it_does is the centerpiece at ~1000 words (6-8 paragraphs). The other four sections are each ~125 words.
...
=== MARKET DATA (for scoring_data object only — do NOT reference these in narrative sections) ===
Market Cap: $AGENT_MCAP | Holders: AGENT_HOLDERS
...
WORD COUNT TARGETS: what_it_does = ~1000 words (6-8 paragraphs, the centerpiece — do NOT cut this short) | who_is_behind_it = ~125 words | what_is_notable = ~125 words | risks_to_monitor = ~125 words | market_opportunity = ~125 words. Total ~1500 words.

{
  "what_it_does": "Write approximately 1000 words across 6-8 paragraphs. Be specific, descriptive, and enthusiastic. This is the main event — do not cut it short.\n\nPARAGRAPH 1 — Core product: What is this agent and what does it actually do? Describe the product or service in rich, concrete detail. What specific problem does it solve, and for whom? Why does this problem matter in the Web3/crypto context? What makes it meaningfully different from a generic chatbot, LLM wrapper, or traditional Web2 equivalent? Draw from the biography (AGENT_BIO), website content, and Twitter bio.\n\nPARAGRAPH 2 — Twitter presence and community: Describe the agent's Twitter identity (AGENT_TWITTER) — what content does it post, what personality does it project, how does it interact with its audience? Is it building a brand or just broadcasting? What does the Twitter bio say, and what does that reveal about the project's positioning and self-image?\n\nPARAGRAPH 3 — Website and go-to-market: Describe the website (AGENT_WEBSITE) and its content — what does it communicate about the product, target user, and value proposition? Is the GTM strategy clear? Does the website feel polished and professional? How does it position the agent relative to the broader Virtuals ecosystem?\n\nPARAGRAPH 4 — Tech stack and infrastructure: What platform or infrastructure does this agent run on? How does Virtuals Protocol provide the autonomy layer — what does AGENT_STATUS status mean technically for this agent's capabilities? What AI or blockchain infrastructure is under the hood? Is there a GitHub, API, or integration layer?\n\nPARAGRAPH 5 — Token mechanics: How does the $AGENT_TICKER token tie into the product — is it an access key, governance token, revenue share mechanism, or speculative asset? What is the token's role in the agent's economy? How are holders incentivized?\n\nPARAGRAPH 6 — Use cases: Walk through 2-3 concrete use cases with tangible value. Name the type of user, the specific problem they have, and how this agent solves it. Be specific and grounded — avoid vague descriptions like 'helps users with crypto'.\n\nPARAGRAPH 7 — Current status: Is the product live and usable right now? What has shipped vs. what is still promised? What does the AGENT_STATUS status indicate about maturity? What verifiable evidence of traction exists (holder count AGENT_HOLDERS, website content, active Twitter)?\n\nPARAGRAPH 8 (include if data supports it) — Roadmap and future direction: What upcoming milestones or features are mentioned in the data? What does the team's stated vision suggest about where this is heading? Any announced integrations, partnerships, or platform expansions worth noting?",

  "who_is_behind_it": "1-2 paragraphs, ~125 words. Focus on the people, their background, and what they've built. Who are the founders — named individuals with verifiable credentials, pseudonymous builders with a track record, or anonymous? If named, describe their prior experience and domain expertise visible from the website or Twitter bio. If pseudonymous but active, describe their presence and credibility signals. If anonymous, note it in one sentence and pivot immediately to what the team has shipped as evidence of capability. Focus on: what prior projects or credentials are visible, whether the team has shipped products before, what their communication style and website quality suggest about professionalism and commitment, and any advisors or backers mentioned. Do NOT reference any on-chain metrics (holders, market cap, volume, etc.) in this section.",

  "what_is_notable": "1-2 paragraphs, ~125 words. Lead with the single most exciting thing about this project — the hook. Focus purely on FUNDAMENTALS: what unique problem this solves, any partnerships or integrations with other protocols, shipped milestones or upcoming roadmap items, ecosystem positioning within Virtuals Protocol or the broader AI agent space, and organic community momentum signals (active Twitter presence, growing Discord/Telegram, notable mentions in the space). Be specific — cite actual features, partner names, or product milestones. Do NOT mention or reference any on-chain chain data, market cap figures, trading metrics, holder counts, VIQ scores, or composite scores. Avoid generic statements.",

  "risks_to_monitor": "1 paragraph, ~125 words. Briefly note the 2-3 most important fundamental risks — factually, without catastrophizing or dwelling. Focus on product and team risks only: team anonymity if present, unproven product-market fit, market saturation in the AGENT_CATEGORY vertical, or critical missing documentation. Do NOT mention on-chain metrics (liquidity, volume, buy/sell ratios, holder counts, market cap) as risks — these fluctuate and are not the focus. Frame each risk as something to watch, and end with what positive development would resolve it. Keep the tone measured — this is an honest footnote, not the thesis of the report.",

  "market_opportunity": "1-2 paragraphs, ~125 words. Paint the bull case for the broader market this project operates in. Cover: (1) The macro narrative — what is the total addressable market for this AGENT_CATEGORY vertical within crypto and beyond? Name the specific niche (e.g. AI influencer marketing, autonomous DeFi agents, Web3 gaming companions). Reference real-world market sizing benchmarks and growth trends where visible in the data. (2) Key competitors and comparables — who else is building in this space on Virtuals Protocol or adjacent ecosystems? How does AGENT_NAME differentiate? Name specific projects or categories. (3) Where does this project fit — early entrant with room to grow, or uniquely differentiated in a crowded space? Keep the tone bullish and forward-looking. Do NOT reference market cap figures, trading data, or VIQ scores.",
...
CRITICAL RULES:
1. Hit the word count targets: what_it_does must be ~1000 words across 6-8 paragraphs — the centerpiece, do NOT cut it short. The other four sections must each be ~125 words. Do not truncate any section.
2. Tone is BULLISH by default. Sound excited about what this project is building. Highlight what's promising, innovative, and differentiated. Risks go only in risks_to_monitor — nowhere else. Never lead with skepticism.
3. ABSOLUTELY NO chain data in narrative sections: do NOT mention holder counts, market cap figures, trading volume, liquidity amounts, buy/sell ratios, or price data in what_it_does, who_is_behind_it, what_is_notable, risks_to_monitor, or market_opportunity. These fluctuate constantly and do not belong in analysis text. Chain data is for scoring_data ONLY.
4. ABSOLUTELY NO score references in narrative sections: do NOT mention VIQ scores, composite scores, or any numerical score in what_it_does, who_is_behind_it, what_is_notable, risks_to_monitor, or market_opportunity.
5. No price predictions of any kind.
6. Never invent facts. If data is missing, say "not publicly available" in one clause and move on — do not dwell.
7. Every score in scoring_data must reflect actual data — not defaults. Anonymous team = doxx_tier 3. No GitHub = low technical scores. Scores must span the full 0-100 range — do NOT default everything to 50.
8. TAM must be niche-specific (e.g. "AI influencer agents on Base L2"), NEVER "the AI market is $XXX trillion"."""
...
async def analyze_agent(agent_data: dict, model: str = None, top_ids: set = None) -> dict:
    ...
    try:
        ...
        message = client.messages.create(
            model=chosen_model,
            max_tokens=8192,
            system="You are a bullish crypto research analyst at a fund that loves finding early-stage gems in the AI agent ecosystem. Write enthusiastic, insight-driven reports (~1500 words total). Lead with what's exciting and promising. Note risks briefly in one section only. NEVER include chain data (market cap, holders, volume, liquidity, buy/sell ratios) or score references in narrative sections — those are for scoring_data only. Every sentence must add new information about the product, team, or market.",
