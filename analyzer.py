...
WORD COUNT TARGETS: what_it_does=~500 words (4-5 paragraphs, the centerpiece) | who_is_behind_it=~125 words | what_is_notable=~125 words | risks_to_monitor=~125 words | market_opportunity=~125 words. Total ~1000 words.
...
CRITICAL RULES:
1. Hit the word count targets: what_it_does must be ~500 words (4-5 solid paragraphs). Each other section must be ~125 words (1-2 paragraphs). Do not write less.
