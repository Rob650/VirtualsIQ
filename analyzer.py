...
CRITICAL RULES:
1. Hit the word count targets: what_it_does must be 500 words minimum (do not cut short). who_is_behind_it, what_is_notable, risks_to_monitor, and market_opportunity must each be 125 words minimum. Do not truncate any section.
